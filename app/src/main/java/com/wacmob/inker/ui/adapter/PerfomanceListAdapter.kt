...
class PerfomanceListAdapter(val context: Context) :
    RecyclerView.Adapter<PerfomanceListAdapter.ViewHolderNew>() {

    inner class ViewHolderNew(binding: RecycleItem2Binding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderNew {
        val recycleItem2Binding: RecycleItem2Binding =
            DataBindingUtil.inflate(LayoutInflater.from(parent.context),
                R.layout.recycle_item2, parent, false)
